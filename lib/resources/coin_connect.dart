...
class CoinConn {
  Future<CoinsModel> coins() async {
    final String urlBase = "https://coingecko.p.rapidapi.com/coins/markets?vs_currency=usd&page=1&per_page=100&order=market_cap_desc";
    Options options = Options(headers: {
      "x-rapidapi-key": env['API_KEY'],
      "x-rapidapi-host": "coingecko.p.rapidapi.com",
    });
    Response response =
        await Dio().get(urlBase, options: options, queryParameters: {"sparkline": "true", "price_change_percentage": "1h", "order": "market_cap_desc"});
    print(response.data);
